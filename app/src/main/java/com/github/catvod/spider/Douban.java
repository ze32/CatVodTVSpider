...
public class Douban extends Spider {
    ...
    private String getPic(JSONObject item) {
        try {
            return item.getJSONObject("pic").optString("normal") + "@Referer=https://api.douban.com/@User-Agent=" + SpUtil.FIREFOX;
        } catch (Exception e) {
            return "";
        }
    }
    ...
    private String getTags(HashMap<String, String> extend) {
        try {
            ...
            return SpUtil.substring(tags.toString());
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        String content = SpUtil.req(recommendUrl, getHeader());
        JSONArray items = new JSONObject(content).optJSONArray("subject_collection_items");
        JSONArray videos = parseVodListFromJSONArray(items);
        String f = SpUtil.req(extend, SpUtil.getHeader(extend));
        return SpUtil.result(classes, f, videos);
    }
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) throws Exception {
        ...
        String content = SpUtil.req(cateUrl, getHeader());
        JSONArray videos = parseVodListFromJSONArray(new JSONObject(content).getJSONArray(itemKey));
