...
public class Dm84 extends Spider {
    ...
    private JSONArray parseVodList(String url) throws Exception {
        String html = SpUtil.req(url, SpUtil.getHeader(siteUrl + "/"));
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        String html = SpUtil.req(detailUrl, SpUtil.getHeader(siteUrl + "/"));
        ...
        String director = SpUtil.find("导演：(.*?)</p>", html);
        String actor = SpUtil.find("主演：(.*?)</p>", html);
        String description = SpUtil.find("剧情：(.*?)</p>", html);
    ...
    public String searchContent(String key, boolean quick, String pg) throws Exception {
        ...
        return SpUtil.result(parseVodList(searchUrl));
    }
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) throws Exception {
        ...
        return SpUtil.result(1, SpUtil.getHeader(), "", lastUrl);
    }
}